...
my_ggpk <- function(...) ggpack(geom_point, ..., color = 'red', warn = NULL)
...
my_ggpk <- function(c, ...) {
  ...
  ggpack(geom_point, dots = dots, ..., color = 'red', warn = 'dots')
}
...
ggpack(geom_point, color = 'red', color = 'blue', warn = 'call')
```
