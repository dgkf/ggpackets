...
Easily build components of ggplots without sacraficing the ease of ggplot's
...
ggpk_labelled_heatmap <- function(...) {
  ggpacket(...) %+%
    ...
    geom_text(.id = c("text", "text1"), color = 'white', vjust = -0.3, 
      fontface = 'bold', ...) %+%
...
ggplot(as.data.frame(OrchardSprays)) + 
  ...
  ggpk_labelled_heatmap(text.color = "black", text2.alpha = 0.5) + 
